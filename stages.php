...
<header class="page-hero page-hero-stage">
    <div class="page-hero-content reveal-on-scroll">
        <span class="page-kicker">Roadmap</span>
        <h1>Our Stages of Growth</h1>
        <p>See where the club is now and how small steps can become larger climate action.</p>
    </div>
</header>
<!-- Sections -->
    <section>
        <h2>ðŸš€ Early Stage</h2>
        <p>In the beginning, we start with just a few members and a vision for change. This is where we are at right now.</p>
    </section>

    <section>
        <h2>ðŸŒ± Growth Stage (Future)</h2>
        <p>We are planning to grow and spread the word and make bigger and better decisions.</p>
    </section>

    <section>
        <h2>ðŸŒŽ Far - Future Goals</h2>
        <p>Our next steps involve larger initiatives, fundraising, and broader environmental advocacy.</p>
    </section>
<p>
