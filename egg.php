...
<header class="page-hero page-hero-egg">
    <div class="page-hero-content reveal-on-scroll">
        <span class="page-kicker">Field Observation</span>
        <h1>Article: Egg</h1>
        <p>A playground discovery opens a conversation about heat, habitat, and local climate effects.</p>
    </div>
</header>
<img src="images/eggimage.png" alt="A picture of the egg" width="500">

<article>
<p>An egg was found on the blacktop of ACE's playground, an unexpected sight. There were no trees nearby, making it impossiable for it to have fallen from a nest, except for if it was accidently interfered with by kids.</p>
<p>While the members of the <?php echo $siteName; ?> are still investigating this scene, <b>a new theory has been developed: the egg would have shattered if it fell from a height. So, an interference may be the case, wether a person or animal. Let us know what you think in the Contact Us page.</b></p>
<p>Although there have been several theories made, none have been proven true yet. <u><b><i>We will update this article once we have more information.</i></b></u>
<h2><b><i><u> To be updated </u></i></b></h2>
<p>
