...
<header class="page-hero page-hero-about">
    <div class="page-hero-content reveal-on-scroll">
        ...
        <h1>About Us</h1>
        <p>Meet the student-led team turning climate concern into practical action.</p>
    </div>
</header>
<main>
    <section class="intro-grid">
      ...
      <a class="intro-card" href="https://sway.cloud.microsoft/DTWEHBtdOijVUepH?ref=Link" target="_blank" rel="noopener">
        <h2>Learn More ðŸ“–</h2>
        <p>Explore our Microsoft Sway for a deep dive into our history, team, and long-term vision!</p>
      </a>
    </section>
    <section>
      <div class="intro-card">
	<h2>ðŸŒ²What we're doing nowðŸŒ³</h2>
	<p>When the weather gets warmer, we're planning to plant 1 tree for every $10 that we raise. Stay tuned for more!</p>
    </section>
    <section>
      <div class="intro-card">
	<h2>How <i>you</i> can stay updated <b>,too</b></h2>
	<p>ðŸ”ƒYou can stay updated by going to this website every month, where we have all the new updates and surprises! See you soon.</p>
    </section>
...
<div class="elfsight-app-ea01090c-eff4-45d4-a0e9-6faea39bbff7" data-elfsight-app-lazy></div>
        <section id="video-section" class="video-section reveal-on-scroll">
            ...
            <div class="video-container">
                <video controls width="100%" poster="video-thumbnail.jpg" preload="none" loading="lazy">
    ...
    <section class="color-panel">
      <h2>ðŸŒˆ Customize Your Experience</h2>
      <p>Choose a theme that fits your mood.</p>
...
<!-- Elfsight Countdown Timer | About Us Countdown Timer -->
<div class="elfsight-app-54b2e08d-0a6f-4d0d-99fd-d5b70963084a" data-elfsight-app-lazy></div>
