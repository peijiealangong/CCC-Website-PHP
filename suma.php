...
<header class="page-hero page-hero-suma">
    <div class="page-hero-content reveal-on-scroll">
        <span class="page-kicker">International</span>
        <h1>Suma Beach Reflections</h1>
        <p>A student observation from Japan on coastal cleanup, plastic waste, and ocean care.</p>
    </div>
</header>
<p>
One of our members recently visited Japan. When she visited Suma Beach, she experienced a surprising sight. She saw a fish made completely out of plastic! She is still gathering information, and one thing she learned was that Suma Beach is known for being clean and well maintained. The <?php echo $siteName; ?> has a hypothisis that workers at Suma Beach collected trash from nearby cities and/or oceans and made 6676it into a plastic fish as a sign of cleanness or a small peaceful protest.
</p>
<p>
More information about her trip to Suma Beach below.
</p>

<p>
At Suma beach, our climate change club member saw absolutely no trash! And, if you can believe it, there is a wildlife conservatory right next to it. Also a public aquarium, this conservatory works hard on learning more and breeding ocean animals.
</p>

<p>
In Japan, our member noticed some really surprising things. Apparently, the official  etiquette is to wash your trash thoroughly before throwing it away. Also, itâ€™s very important to organize your trash properly! Not what you expected, eh?</p>
